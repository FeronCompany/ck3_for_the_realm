...
| 关键人物观望抑制 | `ftr_court_wait_key_figure_ai_modifier` | 0200.f 观望 `base` 35 → **45**；**关键人物**（`ftr_court_wait_key_figure_trigger`：① 军力 ≥ 领主 `ftr_court_wait_key_vassal_strength_ratio_value`=10% 的封臣 ② 内阁成员 ③ 君主宫廷职位持有者 ④ 君主配偶 ⑤ 君主继承人 ⑥ 强力封臣）再 **−35**——举足轻重者不得轻易置身事外 |
