...
- 共治请愿（01 `0220`）路径不受影响：未成年继承人仍走回退分支（请愿者取得 `regency`）；
...
| `events/ftr_diarchy_events.txt` | 0010 警告 / 0020 表态 / 0002 阶段 A 结算（hidden）/ 0210 超时兜底（hidden）/ 0600 发落废君 / 0200 授土提醒 / **0700 成年晋位太子共治（告知君主 + 回执太子）** |
