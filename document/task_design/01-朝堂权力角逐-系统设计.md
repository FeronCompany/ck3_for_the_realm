...
| 0–90 | 不派发互殴手段 | 静默期（原 0001 点缀已移除，低烈度「文明争斗」族待建） |
...
| 文件 | 内容 |
|---|---|
| `common/story_cycles/ftr_court_struggle.txt` | 容器、可视化、effect_group A/B/C、生命周期（主时钟 = 心跳 + on_action 选族；参与询问刷新带「未询问候选」短路） |
...
| `events/ftr_court_struggle_events.txt` | 0003–0040 + 0050–0082 + 0083/0084 + 0085/0086（无 0091/0092 scheme 加工链；0211–0215 调度并入 on_action；0001 潜伏点缀与 0041 君主警觉均已移除） |
