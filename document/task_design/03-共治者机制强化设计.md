...
| `ftr_diarchy_abolish_opinion_mutual_value` / `_abolish_courtly_opinion_value` / `_abolish_*_backer_weight_value` / `_abolish_pressure_cap_value` | 废太子的好感惩罚（双向 / 宫廷派）与 AI 党羽压力（§3.2）；双向好感权重 −0.4 已内联在决议 `ai_will_do` |
