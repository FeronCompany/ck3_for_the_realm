...
graph TD
    ...
    S4 --> OP4["add_to_list<br/>remove_from_list<br/>list_size:name<br/>any_in_list<br/>ordered_in_list"]
...
```paradox
# 出处: common/scripted_effects/03_dlc_fp2_scripted_effects.txt:246
